...
--previous_run_dir /home/v-yifeili/blob/dkibdm/math_word_problems/GSM8K_models/deberta_token_level_stepwise/5epochs_lr1e-5_seed1_bs64 \
--previous_run_epoch 2 \
